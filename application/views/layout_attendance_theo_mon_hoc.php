								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="row">
											...
											<form class='form-inline' method="post" action="<?php echo base_url() ?>attendance/resultAttendance3">
											<div class="form-group">
												...
												<select name="facultyid"  class="form-control">
													...
													<?php 
													foreach ($facultyids as $key => $value) {
												...
												<div class="form-group">
													<label for="pwd">Buổi điểm danh:</label>
												...
												<div class="form-group">
													...
													<input type="submit" class="form-control" value='Lọc kết quả'>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            foreach($data as $k=>$item)
                                            {
                                                ...
                                                <tr>
													...
													<td><?php echo $item['time1'] ?></td>
													<td><?php echo $item['info_staff'] ?></td>
