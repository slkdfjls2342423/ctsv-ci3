...
?>				 <li><a href="<?php echo site_url('quiz');?>">Danh sách đề thi </a></li>
				...
				<li class="dropdown" <?php if($this->uri->segment(1)=='attendance'){ echo "class='active'"; } ?> >
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<?php echo base_url();?>attendance/resultAttendance3">Kết quả điểm danh 3</a></li>
			...
			?>
			  ...
			  <li class="dropdown" <?php if($this->uri->segment(1)=='user_group'){ echo "class='active'"; } ?> >
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
					<?php echo $this->lang->line('setting');?>  <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="<?php echo site_url('notification');?>"><?php echo $this->lang->line('notification');?></a></li>
		...
		<!-- danh gia ren luyen -->
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" 
						aria-expanded="false">Rèn luyện+CTXH-Khen thưởng<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="/etp">Điểm rèn luyện</a></li>
				  <li><a href="/socialwork">Ngày công tác xã hội</a></li>
				  <li><a href="/socialwork/index2">Khen thưởng</a></li>
                 
				</ul>
				</li>
	
		<!-- end of danh gia ren luyen -->
			...
			<?php 
				...
				?>
				<li><a href="<?php echo site_url('form2');?>">Xác nhận sinh viên</a></li>
			<?php 
			if($logged_in['su']==0)
			{
				?>
